...
/**
 * @name BetweenLen
 * Check if the length of the given value is between to other values
 * 
 * @package Catapult.Libraries.Validate.Validators
 * @filesource BetweenLen.php
 * 
 ...
 */
class BetweenLen implements iValidator, iValidatorArgs {
	/**
	 * @var Int $_iMinValue
	...
	public function validate ($mValue) {
		return (strlen ($mValue) >= $this->_iMinValue && strlen ($mValue) <= $this->_iMaxValue) ? true : false;
	}
}
?>